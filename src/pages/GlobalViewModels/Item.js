        ...
        try {
            ...
            if (response.data.success) {
                ...
                this.formRef.current.setFieldsValue({
                    ...
                    SHARE_HOLDERS: this.state.initialValues.SHARE_HOLDERS ? this.state.initialValues.SHARE_HOLDERS.split(',') : undefined,
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Row gutter={16}>
                                        ...
                                        <Col span={6}>
                                            <Form.Item
                                                name="BUYER"
                                                label="Buyer"
                                                initialValue={this.state.initialValues.BUYER}
                                                rules={[
                                                    {
                                            ...
                                            <Form.Item name="SHARE_HOLDERS" label="Share Holders"
                                                       initialValue={
                                                           this.state.initialValues.SHARE_HOLDERS
                                                               ? this.state.initialValues.SHARE_HOLDERS.split(',').map(Number)
                                                               : undefined
                                                       }>
                                    ...
                                    <Row gutter={16}>
                                        ...
                                        <Col span={12}>
                                            <Form.Item name="SELLER" label="Seller" initialValue={this.state.initialValues.SELLER}>
