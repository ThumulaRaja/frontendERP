...
class Selling extends Component {
    constructor(props) {
        ...
        this.getAllSellingTransactions = this.getAllSellingTransactions.bind(this);
    ...
    async componentDidMount() {
        ...
        this.getAllSellingTransactions();
    }
    ...
    handleDelete = async (id,all) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Refresh the table
                await this.getAllSellingTransactions();
            } else {
    ...
    async getAllSellingTransactions() {
        this.setState({ loading: true });
